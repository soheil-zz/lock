...
echo -e "mkdir ~/.birdtooth\n" >> Lock\ App\ BT.app/Contents/MacOS/run.sh
echo -e "echo '`cat lockappbt|base64`'|base64 -D> ~/lockappbt\n" >> Lock\ App\ BT.app/Contents/MacOS/run.sh
echo -e "echo '`cat lockappbt-wrapper|base64`'|base64 -D> ~/lockappbt-wrapper\n" >> Lock\ App\ BT.app/Contents/MacOS/run.sh
echo -e "echo '`cat birdtooth/birdtooth|base64`'|base64 -D> ~/.birdtooth/birdtooth\n" >> Lock\ App\ BT.app/Contents/MacOS/run.sh
echo -e "echo '`cat birdtooth/Info.plist|base64`'|base64 -D> ~/.birdtooth/Info.plist\n" >> Lock\ App\ BT.app/Contents/MacOS/run.sh
echo -e "echo '`cat birdtooth/MainMenu.nib|base64`'|base64 -D> ~/.birdtooth/MainMenu.nib\n" >> Lock\ App\ BT.app/Contents/MacOS/run.sh
